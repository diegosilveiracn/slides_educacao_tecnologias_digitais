...
\begin{frame}{Como acessar?}
	...
	\begin{itemize}
		...
		\begin{enumerate}
			...
			\item Na disciplina Educação em Tecnologias Digitais, escolha \underline{Ambiente Virtual}.
		\end{enumerate}
...
\section{Questões Ética em Tecnologia da Informação}

\begin{frame}
	\frametitle{Ética}
	
	\begin{block}{Definição}
		O código moral que guia as escolhas e os comportamentos de uma pessoa ao longo da vida.
	\end{block}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		\item Uso indevido de informações pessoais;
		\item Desinformação e Deep Fakes;
		\item Tecnologia Autônoma;
		\item Autoria de conteúdos; e
...
\begin{frame}
	...
	\begin{itemize}
		\item Chat-GPT, Gemini e Copilot -- Criação de textos, imagens e vídeos; 
		\item NotebookLM - Resumos e fichamentos;
		\item DALL-E 2 -- Geração de imagens;
